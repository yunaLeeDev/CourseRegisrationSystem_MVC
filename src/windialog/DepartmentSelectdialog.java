...
public class DepartmentSelectdialog extends JDialog {
	private static final long serialVersionUID = 1L;
	private Indexselecttable indexselecttable;
	private LectureSelectdialog lectureSelectdialog; 
	private String filename1;
	public DepartmentSelectdialog(String filename, Omember omember) {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if(!e.getValueIsAdjusting()) {	
					...
					if(result == JOptionPane.CLOSED_OPTION) {		
						...
						lectureSelectdialog = new LectureSelectdialog(filename1, omember);
					} else {
					}
					}
						}
